...
curl_setopt($c2_curl, CURLOPT_USERAGENT, $h2[3]);
$res2 = curl_exec($c2_curl);
curl_close($c2_curl);

// Step 3: Create Link with ID at the start
$n3 = "http://$portal/stalker_portal/server/load.php?type=itv&action=create_link&cmd=ffrt%http://localhost/$id/ch/&JsHttpRequest=1-xml";
...
curl_setopt($c3_curl, CURLOPT_USERAGENT, $h2[3]);
